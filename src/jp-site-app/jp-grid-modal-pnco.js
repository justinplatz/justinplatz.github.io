 ...
 * @polymer
 */
class JpGridModalPnCo extends PolymerElement {
  static get template() {
    return html`
      <style>
        :host {
  ...
  static get properties() {
   ...
   ready() {
    ...
    _addSubscribers(){
      var self = this;
      $.subscribe("_openModalPnCo", function(event, data) {
          self.$.modal.open();
      });
...
window.customElements.define('jp-grid-modal-pnco', JpGridModalPnCo);