...
.goog-imageless-button-checked .goog-imageless-button-top-shadow{background:#e3e3e3;}.goog-imageless-button-active{color:#000;}.goog-imageless-button-hover,
.goog-imageless-button-hover .goog-imageless-button-outer-box,
.goog-imageless-button-focused,
.goog-imageless-button-focused .goog-imageless-button-outer-box{border-color:#000;}* html .goog-imageless-button-inner-box{display:inline;position:static;zoom:1;}* html .goog-imageless-button-outer-box{right:0;}