<!DOCTYPE html><html><head><title>iron-flex-layout-classes tests</title><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1,user-scalable=yes"><script src="../../../@webcomponents/webcomponentsjs/webcomponents-bundle.js"></script><script src="../../../wct-browser-legacy/browser.js"></script><script>define(['../iron-flex-layout-classes.js']);</script><script>define([],function(){"use strict";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<custom-style>
    ...
    </custom-style>`;document.body.appendChild($_documentContainer.content)});</script></head><body><script>define([],function(){"use strict";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<test-fixture id="basic">
      <template>
    ...
    </test-fixture>`;document.body.appendChild($_documentContainer.content)});</script><script>define([],function(){"use strict";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<test-fixture id="flex">
      <template>
        <div class="container layout">
    ...
    </test-fixture>`;document.body.appendChild($_documentContainer.content)});</script><script>define([],function(){"use strict";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<test-fixture id="single-child">
      <template>
        <div class="container layout">
          <div id="c1"></div>
        </div>
      </template>
    </test-fixture>`;document.body.appendChild($_documentContainer.content)});</script><script>define([],function(){"use strict";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<test-fixture id="positioning">
      <template>
        <div class="container layout relative">
          <div id="c1"></div>
        </div>
      </template>
    </test-fixture>`;document.body.appendChild($_documentContainer.content)});</script><script>define([],function(){"use strict";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<test-fixture id="align-content">
      <template>
        <div class="container layout">
          <div id="c1"></div>
          <div id="c2"></div>
