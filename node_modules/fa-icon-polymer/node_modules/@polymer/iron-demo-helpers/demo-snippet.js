...
`,is:"demo-snippet",properties:{_markdown:{type:String}},attached:function(){this._observer=(0,_polymerDom.dom)(this.$.content).observeNodes(function(info){this._updateMarkdown()}.bind(this))},detached:function(){if(this._observer){(0,_polymerDom.dom)(this.$.content).unobserveNodes(this._observer);this._observer=null}},_updateMarkdown:function(){var template=(0,_polymerDom.dom)(this).queryDistributedElements("template")[0];if(!template){this._markdown="";return}var snippet=this.$.marked.unindent(template.innerHTML);snippet=snippet.replace(/=""/g,"");this._markdown="```\n"+snippet+"\n"+"```";if(!template.hasAttribute("is")){(0,_polymerDom.dom)(this.$.content).unobserveNodes(this._observer);this._observer=null;(0,_polymerDom.dom)(this).appendChild(document.importNode(template.content,!0))}},_copyToClipboard:function(){var snipRange=document.createRange();snipRange.selectNodeContents(this.$.code);var selection=window.getSelection();selection.removeAllRanges();selection.addRange(snipRange);var result=!1;try{result=document.execCommand("copy");this.$.copyButton.textContent="done"}catch(err){console.error(err);this.$.copyButton.textContent="error"}setTimeout(this._resetCopyButtonState.bind(this),1e3);selection.removeAllRanges();return result},_resetCopyButtonState:function(){this.$.copyButton.textContent="copy"}})});