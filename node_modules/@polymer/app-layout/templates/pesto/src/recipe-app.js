define(["@polymer/app-route/app-location.js","@polymer/app-route/app-route.js","../../../../iron-flex-layout/iron-flex-layout.js","@polymer/iron-pages/iron-pages.js","../../../../iron-selector/iron-selector.js","../../../../paper-icon-button/paper-icon-button.js","@polymer/paper-item/paper-item.js","../../../../paper-listbox/paper-listbox.js","../../../app-drawer-layout/app-drawer-layout.js","../../../app-drawer/app-drawer.js","../../../app-header-layout/app-header-layout.js","../../../app-header/app-header.js","../../../app-toolbar/app-toolbar.js","./recipe-detail.js","./recipe-list.js","./app-icons.js","../../../helpers/helpers.js","../../../../polymer/lib/legacy/polymer-fn.js","../../../../polymer/lib/utils/html-tag.js"],function(_appLocation,_appRoute,_ironFlexLayout,_ironPages,_ironSelector,_paperIconButton,_paperItem,_paperListbox,_appDrawerLayout,_appDrawer,_appHeaderLayout,_appHeader,_appToolbar,_recipeDetail,_recipeList,_appIcons,_helpers,_polymerFn,_htmlTag){"use strict";(0,_polymerFn.Polymer)({_template:_htmlTag.html`
    <style>
    :host {
...
`,is:"recipe-app",properties:{recipes:Object,_route:Object,_subRoute:Object,_pageData:{type:Object,observer:"_pageDataChanged"},_selectedPage:String,_idData:Object,_scrollPositionMap:{type:Object,value:function(){return{}}}},attached:function(){this.async(function(){if(!this._route.path){this.set("_route.path","/home")}})},_getRecipe:function(){if(this.recipes&&this._idData&&this._idData.id){for(var i=0,r;i<this.recipes.length;++i){r=this.recipes[i];if(r.id===this._idData.id){return r}}}return null},_drawerSelected:function(){if(!this.$.drawer.persistent)this.$.drawer.close()},_pageDataChanged:function(pageData,oldPageData){var map=this._scrollPositionMap;if(null!=oldPageData&&null!=oldPageData.page){map[oldPageData.page]=window.pageYOffset}this._selectedPage=pageData.page;if(null!=map[pageData.page]){(0,_helpers.scroll)({top:map[pageData.page],behavior:"silent"})}else if(this.isAttached){(0,_helpers.scroll)({top:0,behavior:"silent"})}}})});