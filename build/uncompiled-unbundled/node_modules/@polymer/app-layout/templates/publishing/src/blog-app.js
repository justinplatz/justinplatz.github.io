import"@polymer/app-route/app-location.js";import"@polymer/app-route/app-route.js";import"../../../../iron-flex-layout/iron-flex-layout.js";import"@polymer/iron-pages/iron-pages.js";import"../../../../iron-selector/iron-selector.js";import"@polymer/paper-fab/paper-fab.js";import"../../../../paper-icon-button/paper-icon-button.js";import"../../../../paper-styles/shadow.js";import"../../../app-drawer-layout/app-drawer-layout.js";import"../../../app-drawer/app-drawer.js";import"../../../app-scroll-effects/app-scroll-effects.js";import"../../../app-header/app-header.js";import"../../../app-header-layout/app-header-layout.js";import"../../../app-toolbar/app-toolbar.js";import"./app-icons.js";import"./article-headline.js";import"./article-detail.js";import"./two-columns-grid.js";import{scroll}from"../../../helpers/helpers.js";import{Polymer}from"../../../../polymer/lib/legacy/polymer-fn.js";import{html}from"../../../../polymer/lib/utils/html-tag.js";Polymer({_template:html`
    <style>
...
`,is:"blog-app",properties:{articles:Object,route:Object,subRoute:Object,subsubRoute:{type:Object,observer:"_subsubrouteChanged"},categoryData:Object,pageData:Object,idData:Object,_scrollPositionMap:{type:Object,value:function(){return{}}}},observers:["_updateArticle(articles, categoryData.category, idData.id)"],attached:function(){this.async(function(){if(!this.route.path){this.set("route.path","/art/list")}})},_equal:function(value1,value2){return value1===value2},_updateArticle:function(articles,category,id){if(!articles){return}for(var i=0,cat;cat=articles[i];i++){if(cat.name===category){for(var j=0,article;article=cat.items[j];j++){if(article.id===id){this.article=article;return}}}}},_drawerSelected:function(){if(!this.$.drawer.persistent)this.$.drawer.close()},_shouldHideMenuButton:function(page,narrow){return"detail"===page||!narrow},_subsubrouteChanged:function(subroute,oldSubroute){var map=this._scrollPositionMap;if(null!=oldSubroute&&null!=oldSubroute.prefix){if(-1==oldSubroute.prefix.indexOf("detail")){map[oldSubroute.prefix]=window.pageYOffset}}if(null!=map[subroute.prefix]){scroll({top:map[subroute.prefix],behavior:"silent"})}else if(this.isAttached){scroll({top:0,behavior:"silent"})}}});