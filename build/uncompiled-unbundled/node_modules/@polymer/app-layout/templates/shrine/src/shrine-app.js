import"@polymer/app-route/app-location.js";import"@polymer/app-route/app-route.js";import"../../../../iron-flex-layout/iron-flex-layout.js";import"../../../../iron-media-query/iron-media-query.js";import"../../../../paper-icon-button/paper-icon-button.js";import"@polymer/paper-tabs/paper-tabs.js";import"../../../../iron-icons/iron-icons.js";import"@polymer/iron-pages/iron-pages.js";import"../../../app-layout.js";import"../../../app-scroll-effects/app-scroll-effects.js";import"./shrine-list.js";import"./shrine-detail.js";import{scroll}from"../../../helpers/helpers.js";import{Polymer}from"../../../../polymer/lib/legacy/polymer-fn.js";import{html}from"../../../../polymer/lib/utils/html-tag.js";Polymer({_template:html`
    <style>
...
`,is:"shrine-app",properties:{sections:{type:Array,value:function(){return["feature","latest","fashion","furniture","beauty","food","travel"]}},selectedTab:{type:Number,computed:"_computeSelectedTab(sections, sectionData.section)"},items:{type:Array},featuredItems:{type:Array},page:{type:String,computed:"_computePage(onDetailPage)",reflectToAttribute:!0},route:Object,subRoute:Object,sectionData:Object,idData:Object,onDetailPage:Boolean},observers:["_hashDidChange(route.path, items, featuredItems)"],attached:function(){this.async(function(){if(!this.route.path){this.set("route.path","feature")}})},_computeSelectedTab:function(sections,section){return sections.indexOf(section)},_getItemsCopy:function(items){return items?items.slice():[]},_getFeaturedItem:function(featuredItems,section){if(featuredItems&&section){return featuredItems.filter(function(item){return item.category.toLowerCase()===section}).pop()}return""},_getDetailItem:function(items,id){if(items){return items[id]}},_computePage:function(onDetailPage){return onDetailPage?"detail":"list"},_hashDidChange:function(){scroll({top:0,behavior:"silent"});this.$.headerLayout.resetLayout();this.$.drawer.close()},_equal:function(a,b){return a===b},_getSectionClass:function(index,selectedTab){return index===selectedTab?"active":""},_shouldShowTabs:function(onDetailPage,smallScreen){return!onDetailPage&&!smallScreen}});