...
function isEsModuleDocument(doc) {
  return doc.type === 'js' && doc.parsedDocument.parsedAsSourceType === 'module';
}
...
const resolveKinds = ['element', 'behavior', 'element-mixin', 'class', 'function', 'namespace']; //# sourceMappingURL=es-modules.js.map