...
<body>
  ...
  <dom-module id="x-grid">
    ...
    <script type="module">import "../../../polymer/polymer-legacy.js";
...
Polymer({
  ...
  _getAPIEndpoint: function (apiKey, userId, page) {
    return 'https://api.flickr.com/services/rest/?method=flickr.photos.search' + '&api_key=' + apiKey + '&safe_search=1&sort=interestingness-desc' + '&user_id=' + userId + '&page=' + page + '&format=json' + '&per_page=' + this.perPage;
  },
  ...
  _getItemStyle: function (photo) {
    return 'background-image: url(//farm' + photo.farm + '.staticflickr.com/' + photo.server + '/' + photo.id + '_' + photo.secret + '_b.jpg);';
  }
});</script>
  </dom-module>
