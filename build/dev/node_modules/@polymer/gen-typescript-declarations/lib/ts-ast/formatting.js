...
function formatComment(comment, depth) {
  ...
  comment = comment.replace(/\*\//g, '*\\/'); // Indent the comment one space so that it doesn't touch the `*` we add next,
  ...
  comment = comment.replace(/^(.)/gm, ' $1'); // Indent to the given level and add the `*` character.
...
exports.formatComment = formatComment; //# sourceMappingURL=formatting.js.map