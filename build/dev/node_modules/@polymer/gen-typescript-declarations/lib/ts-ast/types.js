...
exports.NameType = NameType; // foo|bar
...
exports.UnionType = UnionType; // Array<foo>
...
exports.ArrayType = ArrayType; // Foo<Bar>
...
exports.ParameterizedType = ParameterizedType; // (foo: bar) => baz
...
exports.FunctionType = FunctionType; // {new(foo): bar}
...
exports.ConstructorType = ConstructorType; // foo: bar
...
exports.undefinedType = new NameType('undefined'); //# sourceMappingURL=types.js.map